...
experiment_name = "MobileNetV3Small_exp14_1000epoch_10fold_3segment_1frampersegment_batchsize32"

#optimizer_config = optimizer_settings_ResNet50(model, lr, lambda_reg, momentum)
optimizer_config = torch.optim.Adam(model.classifier.parameters(), lr=lr)
